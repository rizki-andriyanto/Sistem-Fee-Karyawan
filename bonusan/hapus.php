...
if(isset($_GET['id'])){
	...
	$cek = mysql_query("SELECT ID_BONUSAN FROM BONUSAN WHERE ID_BONUSAN='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM BONUSAN WHERE ID_BONUSAN='$id'");
		
		//jika query DELETE berhasil
		if($del){
			
			echo 'Data bonusan berhasil di hapus! ';		//Pesan jika proses hapus berhasil
