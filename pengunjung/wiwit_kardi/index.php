...
<html>
<head>
	<title>BONUSAN WIWIT-KARDI</title>
</head>
<p>
...
echo '<font size="5" color="blue" >'.'<b>'."Selamat Datang, ".'<font color="red">'.'</b>'.$hasil['nama'].'</font>'; 
...
<table cellpadding="10" cellspacing="0" border="5">
		<tr bgcolor="red">
			<span align="center"><th ><marquee bgcolor="red"><font size="50" color="white">BONUSAN WIWIT dan KARDI </font></marquee></th></tr></span>
	...
	$query = mysql_query("SELECT  NAMA_PARTNER,
				...
				DETAIL_BONUSAN.ID_BONUSAN=BONUSAN.ID_BONUSAN WHERE NAMA_PARTNER='WIWIT-KARDI' and DATE LIKE
 ...
 WHERE NAMA_PARTNER='WIWIT-KARDI'  and DATE LIKE
				'".$deteksi."%' " ) or die(mysql_error());
