...
<html>
<head>
	<title>BONUSAN RONI-JUMALI</title>
</head>
...
<table cellpadding="10" cellspacing="0" border="5">
		<tr bgcolor="red">
			<span align="center"><th ><marquee bgcolor="red"><font size="50" color="white">BONUSAN RONI dan JUMALI </font></marquee></th></tr></span>
	...
	$query = mysql_query("SELECT  NAMA_PARTNER,
				...
				DETAIL_BONUSAN.ID_BONUSAN=BONUSAN.ID_BONUSAN WHERE NAMA_PARTNER='RONI-JUMALI' and DATE LIKE
 ...
 WHERE NAMA_PARTNER='RONI-JUMALI'  and DATE LIKE
				'".$deteksi."%' " ) or die(mysql_error());
