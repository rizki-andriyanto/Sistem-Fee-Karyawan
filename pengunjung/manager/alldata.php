 ...
 <td bgcolor="orange">
	...
	<table cellpadding="35" cellspacing="0" border="15">
		...
		$query = mysql_query("SELECT ID_DETAIL_BONUSAN,NAMA_PARTNER,DATE,MOBIL,RANGPOL,NAMA_BONUSAN,POIN_BONUSAN
 		FROM DETAIL_BONUSAN INNER JOIN PARTNER ON DETAIL_BONUSAN.ID_PARTNER=PARTNER.ID_PARTNER INNER JOIN BONUSAN ON DETAIL_BONUSAN.ID_BONUSAN=BONUSAN.ID_BONUSAN ORDER BY DATE " ) or die(mysql_error());
